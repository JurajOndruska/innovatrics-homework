 ...
 * {@linkplain TaskProcessMap#executeForTaskId(String, TaskProcessMapTimeOutAction, long)}.
 *
 ...
 * @since 1.0.0
 */
interface TaskProcessMapTimeOutAction<R, E extends Throwable> {
     ...
     * @param timeLeft the remaining time (in milliseconds) left from
     * the original timeout (which was partially consumed when thread safe
     ...
     */
    R execute(Map<String, ImmutableTaskProcess> mapView, TaskProcessMapEntry mapEntry, long timeLeft) throws E, TimeoutException;
}
